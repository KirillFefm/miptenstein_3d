...
Player::Player()
    ...
    , m_armor(0), m_maxArmor(Config::PLAYER_MAX_ARMOR), m_score(0)
...
void Player::addAmmo(int amount) { m_ammo[(int)m_currentWeapon] = std::min(m_maxAmmo[(int)m_currentWeapon], m_ammo[(int)m_currentWeapon] + amount); }
